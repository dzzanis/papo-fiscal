...
Têm por finalidade reduzir o débito de IBS e CBS na apuração do contribuinte emitente e, quando aplicável, gerar o correspondente lançamento a crédito na apuração do contribuinte destinatário.
...
Para fins de desfazimento do débito de IBS e CBS, o contribuinte deverá emitir uma nota fiscal de crédito do tipo “03 – Retorno por Recusa na Entrega ou por Não Localização do Destinatário na Tentativa de Entrega” ou "06 - Retorno por Recusa Parcial na Entrega".

⚠️ A Cartilha Orientativa do CGIBS apresenta orientação de emitir a nota informando a si próprio como emitente e destinatário no arquivo XML. Na redação original do Ajuste Sinief 49/25 não mencionava nada sobre isso, contudo o mesmo foi modificado pelo Ajuste Sinief 8/2026, passando exigir um procedimento distinto, de informar como destinatário da NF-e as informações do destinatário da respectiva nota de saída original. Cabe agora ao contribuinte, decidir se segue a orientação da cartilha ou a legislação do Ajuste Sinief, sendo interessante verificar a efetiva regulamentação dado pelo seu estado.
...
<div class="text-left text-[#8b5cf6] gap-0 shadow-[0.1rem_0.2rem_0.2rem_0.2rem_lightgray] rounded-2xl box-border transition ease-in-out delay-150 sm:hover:scale-105 hover:-translate-y-1 p-3">
  <ul class="flex flex-col gap-2">
    ...
    <li class="sm:text-sm text-xs text-[#8b5cf6]">tpNFCredito = 03 (Retorno por recusa ou não localização) ou 06 (Retorno por Recusa Parcial na Entrega)</li>
    ...
    <li class="sm:text-sm text-xs text-[#8b5cf6]">refNFe = chave da nota original em caso de recusa total ou não localização do destinatário</li>
    <li class="sm:text-sm text-xs text-[#8b5cf6]">DFeReferenciado : referenciar itens da NF-e de saída original em caso de recusa parcial</li>
...
<div class="text-left text-[#8b5cf6] gap-0 shadow-[0.1rem_0.2rem_0.2rem_0.2rem_lightgray] rounded-2xl box-border transition ease-in-out delay-150 sm:hover:scale-105 hover:-translate-y-1 p-3">
  <ul class="flex flex-col gap-2">
    <li class="sm:text-sm text-xs text-[#8b5cf6]">Se a NF-e de saída não puder ser cancelada, o remetente deve emitir NF-e de entrada com:</li>
    <li class="sm:text-sm text-xs text-[#8b5cf6]">finNFe = 5 (Nota de crédito)</li>
