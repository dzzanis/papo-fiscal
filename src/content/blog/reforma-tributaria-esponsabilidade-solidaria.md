---
author: Papo Fiscal
pubDatetime: 2025-11-27T07:08:00Z
title: 🔥Responsabilidade Solidária na Reforma Tributária
slug: reforma-tributaria-responsabilidade-tributaria-solidaria
featured: true
draft: false
tags:
  - Reforma Tributária
  ...
  - Know Your Supply
description: As empresas precisam fazer uma análise de risco frente o aumento da responsabilidade tributária solidária e correm para estruturar um processo de Know Your Supply (Conheça seus Fornecedores).
---
...
- Aquele que adquire, importe, recebe, dê entrada ou saída ou mantenha em depósito bem, ou toma serviço, que não esteja acobertado por documento fiscal idôneo;
- O transportador, inclusive quando se tratar de empresa de serviço postal ou entrega expressa, nas hipóteses em que o bem transportado esteja desacobertado de documento fiscal idôneo ou quando o transportador efetuar a entrega do bem em local distinto daquele indicado no documento fiscal;
- O leiloeiro, pelo IBS e pela CBS devidos na operação realizada em leilão;
- Desenvolvedores ou fornecedores de programas ou aplicativos utilizados para registro de operações com bens ou com serviços que possuam funções ou comandos que visem descumprir a legislação tributária;
- Qualquer pessoa física, jurídica ou entidade sem personalidade jurídica que contribua, por ato ou omissão, para o descumprimento de obrigações tributárias, por meio de ocultação da ocorrência do valor da operação, ou por abuso da personalidade jurídica, caracterizado pelo desvio de finalidade ou pela confusão patrimonial;
- O entreposto aduaneiro, do recinto alfandegado ou do estabelecimento a ele equiparado, do depositário ou do despachante, em relação:
  - ao bem que seja destinado ao exterior e não possua documentação correspondente;
  - ao bem que seja recebido para exportação, mas que não venha a ser exportado;
...
- **Responsabilidade Solidária:**
  Todos os devedores compartilham a dívida integralmente. O credor pode cobrar de qualquer um deles ou de todos ao mesmo tempo. É prevista em lei ou contrato.

- **Responsabilidade Subsidiária:**
  O devedor principal é cobrado primeiro. Se ele não pagar, os outros devedores podem ser acionados. É mais comum em casos de inadimplência, especialmente trabalhista.

- 🚨**Diferença-chave:**
  - `Solidária`: Todos responsáveis de forma direta e sem condições.
  - `Subsidiária`: Responsabilidade acontece apenas se o devedor principal não arcar com suas obrigações.
...
- `Verificação`: A empresa investiga informações sobre os fornecedores, como histórico, idoneidade financeira e conformidade legal.
- `Avaliação de riscos`: A análise ajuda a identificar potenciais riscos e a determinar a necessidade de cuidados extras ou cláusulas contratuais.
- `Monitoramento contínuo`: A prática exige a atualização constante das informações para garantir que o fornecedor mantenha o alinhamento com os padrões da empresa ao longo do tempo.
- `Implementação`: Envolve a definição de objetivos, a identificação de fornecedores críticos e o estabelecimento de um processo de coleta, avaliação e monitoramento de informações.
